(function attachDogPresets(root, factory) {
  ...
  const catalog = Object.freeze([
    ...
    preset("toy-poodle", "Toy Poodle", "토이 푸들", 12, 0.5, 0.5),
    ...
    preset("shiba-inu", "Shiba Inu", "시바 이누", 13.5, 0.59, 0.56),
    preset("siberian-husky", "Siberian Husky", "시베리안 허스키", 16, 0.72, 0.52),
    preset("pomeranian", "Pomeranian", "포메라니안", 11.5, 0.46, 0.57),
    preset("border-collie", "Border Collie", "보더 콜리", 15.5, 0.68, 0.59),
    preset("welsh-corgi", "Welsh Corgi", "웰시 코기", 13.5, 0.62, 0.54),
